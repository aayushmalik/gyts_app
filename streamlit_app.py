...
st.sidebar.write(
    "[Global Youth Tobacco Survey](https://www.who.int/teams/noncommunicable-diseases/surveillance/systems-tools/global-youth-tobacco-survey)"
)
st.sidebar.write(
...
st.sidebar.write(
    "Data Sources: [World Health Organisation](https://www.data.gov.in/catalog/global-youth-tobacco-survey-gyts-4)"
)
